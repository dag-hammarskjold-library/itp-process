...
class Snapshot(object):
    ...
    def fields_to_extract(self):
        ...
        if itpp_doc is not None: 
            ...
            itp_bib_fields=['001', '035$a', '089$b', '191$9', '191$a', '191$b', '191$c', '191$d', '191$z', '239$a', '245$a', '245$b', '245$c', '248$a', '249$a', '269$a', '495$a', '515$a', '520$a', '580$a', '591$a', '592$a', '598$a', '599$a', '700$a', '700$g', '710$a', '711$a', '791$a', '791$b', '791$c', '793$a', '930$a', '949$a', '967$c', '967$d', '968$c', '968$d', '969$c', '969$d', '991$a', '991$b', '991$c', '991$d', '991$e', '991$m', '991$s', '991$z', '992$a', '995$a', '996$a', '996$a', '260$a', '260$b', '260$c', '300$a', '300$b', '967$a']
