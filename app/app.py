...
from app.word import generateWordDocITPITSC,generateWordDocITPITSP,generateWordDocITPITSS,generateWordDocITPSOR,generateWordDocITPRES,generateWordDocITPSUBJ,generateWordDocITPDSL,generateWordDocITPMEET,generateWordDocITPAGE,generateWordDocITPVOT,generateWordDocITPREPS
...
def generateWordFile(param_title,param_subtitle,body_session,param_section):
    ...
    if os.environ.get('ZAPPA') == "true":
        ...
        if param_section=="itpreps":
            response = get_document_async('generateWordDocITPREPS', param_title, param_subtitle, body_session, param_section, param_name_file_output, key)
        ...
        if param_section=="itpreps":
            document = get_document_async('generateWordDocITPREPS', param_title, param_subtitle, body_session, param_section, param_name_file_output, key)
